...
function AIChatbot({ reportContext, activeTarget }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 no-print flex flex-col items-end">
      ...
      {isOpen && (
        <div className="cyber-glass rounded-2xl border border-slate-800/90 w-[360px] sm:w-[420px] h-[520px] flex flex-col shadow-2xl overflow-hidden mb-3 animate-in fade-in slide-in-from-bottom-5 duration-300">
          {/* Header */}
          <div className="bg-slate-950/80 border-b border-slate-900 px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="bg-gradient-to-br from-indigo-500 to-cyan-500 p-1.5 rounded-lg text-white shadow-md shadow-cyan-500/20">
                <Bot size={16} />
              </div>
              <div>
      ...
      {!isOpen && (
        <button
          ...
          className="group relative bg-gradient-to-br from-indigo-600 to-cyan-600 hover:from-indigo-500 hover:to-cyan-500 text-white p-3.5 rounded-full shadow-2xl shadow-cyan-500/30 flex items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95 border border-cyan-400/30"
